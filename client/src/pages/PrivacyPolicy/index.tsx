    ...
    <div className="w-full mt-20 pb-20 text-white flex flex-col items-center">
      ...
      <div className="py-16 w-3/4">
        ...
        <p className="mt-4 leading-8">
          At Vanilla Tweaks, accessible from https://vanillatweaks.net/, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Vanilla Tweaks and how we use it.
        </p>
        <p className="mt-4 leading-8">
        ...
        <p className="mt-4 leading-8">
          ...
          shared and/or collect in Vanilla Tweaks. This policy is not applicable
          to any information collected offline or via channels other than this
          website.
        </p>
        <h2 className="text-3xl font-semibold mt-8">Consent</h2>
        <p className="mt-4 leading-8">
        ...
        <h2 className="text-3xl font-semibold mt-8">Log Files</h2>
        <p className="mt-4 leading-8">
          Vanilla Tweaks follows a standard procedure of using log files. These
        ...
        <h2 className="text-3xl font-semibold mt-8">Cookies and Web Beacons</h2>
        <p className="mt-4 leading-8">
          Like any other website, Vanilla Tweaks uses &apos;cookies&apos;. These
        ...
        <ul className="list-disc list-inside pl-4 leading-8">
          <li>
            <p className="mt-4 leading-8">Google</p>
            <p className="mt-4 leading-8">
              <a
                href="https://policies.google.com/technologies/ads"
                target="_blank"
        ...
        <p className="mt-4 leading-8">
          ...
          advertising partners of Vanilla Tweaks.
        </p>
        <p className="mt-4 leading-8">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Vanilla Tweaks, which are sent
        ...
        <p className="mt-4 leading-8">
          Note that Vanilla Tweaks has no access to or control over these
        ...
        <p className="mt-4 leading-8">
          Vanilla Tweaks&apos;s Privacy Policy does not apply to other
        ...
        <p className="mt-4 leading-8">
          Vanilla Tweaks does not knowingly collect any Personal Identifiable
